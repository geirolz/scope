...
// modelMapperKForUserContract: ModelMapperK[Try, Scope.Endpoint, User, UserContract] = scope.ModelMapperK@c3d822a
```
...
// scopeCtx: TypedScopeContext[Scope.Endpoint] = scope.TypedScopeContext@7943a4ac
